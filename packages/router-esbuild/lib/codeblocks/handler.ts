export const mainHandlerCodeblock = [
  ...
  "",
  "interface MaxRouterHandlerOptions {",
  ...
  "",
  "const createHandler = ({ schema, middleware = [], ...METHODS }: MaxRouterHandlerOptions) => {",
  ...
  "};",
  "",
  "exports.main = createHandler(<MaxRouterHandlerOptions>exports);",
  "",
];
